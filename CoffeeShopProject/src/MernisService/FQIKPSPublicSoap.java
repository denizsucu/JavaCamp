...
public class FQIKPSPublicSoap
{
    ...
    public FQIKPSPublicSoap(){}

    public FQIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FQIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FQIExtendedSoapSerializationEnvelope envelope= new FQIExtendedSoapSerializationEnvelope(FQIExtendedSoapSerializationEnvelope.VER11);
