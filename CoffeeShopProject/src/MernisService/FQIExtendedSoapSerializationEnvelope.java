...
public class FQIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FQIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FQIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FQIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FQIDateTimeConverter dateTimeConverter = new FQIStandardDateTimeConverter();

    public FQIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FQIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FQIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FQIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FQIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FQIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
