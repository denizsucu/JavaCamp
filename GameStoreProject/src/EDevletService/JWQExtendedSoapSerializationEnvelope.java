...
public class JWQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JWQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JWQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JWQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JWQDateTimeConverter dateTimeConverter = new JWQStandardDateTimeConverter();

    public JWQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JWQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JWQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JWQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JWQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JWQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
