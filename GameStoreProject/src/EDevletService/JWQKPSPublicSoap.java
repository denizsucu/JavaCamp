...
public class JWQKPSPublicSoap
{
    ...
    public JWQKPSPublicSoap(){}

    public JWQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JWQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JWQExtendedSoapSerializationEnvelope envelope= new JWQExtendedSoapSerializationEnvelope(JWQExtendedSoapSerializationEnvelope.VER11);
